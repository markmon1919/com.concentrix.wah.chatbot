...
namespace com.concentrix.wahit.chatbot
{
    ...
    public static class CommonManager
    {
        ...
        /// <summary>
        /// Returns a User from cache or creates a new one, based upon their Jabber username, allowing the bot to track conversations per user.
        /// </summary>
        /// <param name="jid">unique string ID (jabber username)</param>
        ...
        /// </summary>
        /// <param name="username">Jabber Username</param>
        /// <returns>Password</returns>
        public static string GetPasswordFromConsole(string username)
        {
            Console.Write("Please enter the Jabber password for " + username + ":");
